...
//this??? - player talking
let ch1_22 = new Scene('What can I say? My stories are superb. What I read, what I write. It’s all in good taste.', '', '', ch1, []);
let ch1_21 = new Scene('$n! $n! $n! I can’t believe he knows who you are. You’re, like, a nobody!', 'hPatricia', 'gym', ch1 [ch1_22]);
let ch1_20_3 = new Scene('Yes! See you there.','sThomas', 'gym', ch1, [ch1_21]})
...
let ch1_20 = new Scene('Hey! Y/N right? It’s kinda sudden, but would you mind joining us this Friday after school in the theater to write a play? I’ve heard a lot about your stories.', 'hThomas', 'gym', ch1, [
    {
        'text': 'I can’t… sorry.', 
        'nextScene': ch1_20_1
    },
...
let ch1_16_3 = new Scene('What’s wrong with you? Have you seen him?', 'hPatricia', 'hallway', ch1, []);
let ch1_16_2 = new Scene('That’s ‘cause you have no taste. Your fictional characters set the standard too high. You gotta see him for yourself.', 'hPatricia', 'hallway', ch1, []);
let ch1_16_1 = new Scene('Are you serious?? Only the nicest, handsomest, bestest guy in the school!', 'hPatricia', '', ch1, []);
...
let ch1_9 = new Scene('Hmm… what an interesting goal. Nice to meet you, $n. Next up is Ami.', 'nTeacher', 'classroom', ch1, [ch1_10]);
...
let ch1_7 = new Scene('Now, now, settle down. $n, why don’t we start with you?', 'nTeacher', 'classroom', ch1, [ch1_8]);
